"""
Django settings for senderos project.
...
SECRET_KEY = 'django-insecure-ch4u7kbjb2b6e_^1^gogwz$du3^(gn!_sg@u^7nlm1rv7lpeme'
...
DATABASES = {
		'default': {
			...
			'NAME': 'ssbw',
			'CLIENT':{
				'host': 'mongodb+srv://ssbwuser:ssbwpassword@cluster0.xoro9.mongodb.net/ssbw?retryWrites=true&w=majority',
				'port': 27017,
				'username': 'ssbwuser',
				'password': 'ssbwpassword',
			}
	}
}
